  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <header className="sticky top-0 z-20 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-gray-900 leading-none">SEO Dashboard</h1>
      ...
      <footer className="max-w-7xl mx-auto px-6 py-6 border-t border-gray-100 mt-8">
        <p className="text-xs text-gray-300 text-center">SEO Dashboard · GA4 · Search Console · AI Channels</p>
      </footer>
    </div>
  );
}
